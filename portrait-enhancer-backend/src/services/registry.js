...
export const SERVICE_REGISTRY = [
  ...
  },
  {
    ...
    tier:        "3/day",
    type:        "cloud",
    description: "PicWish AI portrait enhancement — 3 free credits/day",
    fn:          enhanceWithPicwish,
    isAvailable: () => !!process.env.PICWISH_API_KEY,
  },
    {
    id:          "realesrgan",
    name:        "Real-ESRGAN",
    tier:        "local",
    type:        "local",
    description: "Real-ESRGAN local upscaler — no API key needed, runs on-device",
